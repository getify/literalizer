...
(function UMD(name,context,definition) {
	...
	function tokenize(code) {
		...
		// did we end in a non-general state (probably an error)?
		if (lexing_state === STATE_MULTI_LINE_COMMENT) {
			throw new SyntaxError("Unterminated multi-line comment at end of file");
		}
		else if (lexing_state === STATE_STRING_LITERAL) {
			throw new SyntaxError("Unterminated string literal at end of file");
		}
		else if (lexing_state === STATE_BACKTICK_LITERAL) {
			throw new SyntaxError("Unterminated template string at end of file");
		}
		else if (lexing_state === STATE_REGEX_LITERAL_CANDIDATE) {
			throw new SyntaxError("Unterminated regular expression literal at end of file");
		}
